...
const features = [
  ...
  },
  {
    title: "Shadcn/ui",
    description:
      "Includes a blog and a full-featured documentation site built using Contentlayer and MDX.",
    icon: (
...
export default async function IndexPage() {
  ...
  return (
    <>
      <section className="space-y-6 py-10 md:pb-12 lg:py-28">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          <Link
            ...
            className="animate-fade-up rounded-2xl bg-muted px-4 py-1.5 text-sm font-medium opacity-0"
          ...
          >
            <Balancer>
              Build your next project using Next.js 13, shadcn/ui, NextAuth.js,
              Prisma, Planetscale, Typescript.
            </Balancer>
          </p>
      ...
      <section
        className="animate-fade-up py-12 opacity-0"
        style={{ animationDelay: "0.5s", animationFillMode: "forwards" }}
      >
        <div className="container mx-auto">
          <h2 className="text-center font-heading text-2xl">Powered by</h2>

          <div className="my-7 flex items-center justify-center space-x-14">
